...
//         guestId: !userId ? (guestId || `guest_${Date.now()}`) : undefined,
//         products: [],
//         totalPrice: 0
//       });
//     }
...
//   return await Cart.findOne(query).populate('products.productId');
// };
...
// // Get cart - handles both guest and authenticated users
// router.get('/', async (req, res) => {
//   const { userId, guestId } = req.query;
...
//         userId: userId || undefined,
//         guestId: (!userId && guestId) ? guestId : undefined,
//         products: [],
//         totalPrice: 0
//       });
...
//       cart = new Cart({
//         userId: userId || undefined,
//         guestId: (!userId && guestId) ? guestId : `guest_${Date.now()}`,
//         products: [],
//         totalPrice: 0
//       });
//     }
...
//     guestCart.products.forEach(guestItem => {
//       const existingItem = userCart.products.find(item => 
//         item.productId.toString() === guestItem.productId.toString()
//       );
